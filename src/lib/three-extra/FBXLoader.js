	...
	function parseMaterial( materialNode, textureMap, connections ) {
		...
		switch ( type.toLowerCase() ) {
			...
			case 'lambert':
				...
				break;
			default:
				console.warn( 'THREEFBXLoader: unknown material type "%s". Defaulting to MeshPhongMaterial.', type );
	...
	function parseParameters( properties, textureMap, childrenRelationships ) {
		...
		for ( var childrenRelationshipsIndex = 0, childrenRelationshipsLength = childrenRelationships.length; childrenRelationshipsIndex < childrenRelationshipsLength; ++ childrenRelationshipsIndex ) {
			...
			switch ( type ) {
				...
				default:
					console.warn( 'THREEFBXLoader: %s map is not supported in three.js, skipping texture.', type );
					break;
					...
					case 'Camera':
						...
						if ( cameraAttribute === undefined ) {
							...
							switch ( type ) {
								...
								default:
									console.warn( 'THREEFBXLoader: Unknown camera type ' + type + '.' );
									model = new THREE.Object3D();
									break;
					...
					case 'Light':
						...
						if ( lightAttribute === undefined ) {
							...
							switch ( type ) {
								...
								default:
									console.warn( 'THREEFBXLoader: Unknown light type ' + lightAttribute.LightType.value + ', defaulting to a THREE.PointLight.' );
